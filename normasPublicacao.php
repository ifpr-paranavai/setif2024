...
<body>
    ...
    <section class="container-fluid normas-datas py-5">
        <div class="row border-bottom">
            ...
            <div class="col-12 col-md-6 p-4 text-secondary normas-submissao">
                <h2>Submissão</h2>
                <p class="fs-5">A submissão deve ser feita em duas etapas:</p>
                <ol>
                ...
                <p class="fs-5">Sistema de submissão: 
                    <a href="https://tecnoif.com.br/sistemas/openconf/openconf.php" target="_blank" class="btn btn-outline-success">Clique aqui</a>
                </p>

                <h2 class="mt-4">Artigos completos</h2>
                <p class="fs-5">Devem ter no máximo 12 páginas, seguindo o modelo da SBC:</p>
                <ul>
                    <li>LaTeX: 
                        <a href="https://www.overleaf.com/latex/templates/sbc-conferences-template/blbxwjwzdngr" target="_blank" class="btn btn-outline-success">Ver template no Overleaf</a>
                    </li>
                    <li class="mt-2">Modelo SBC .doc: 
                        <a href="https://drive.google.com/file/d/1H_29Hg5N534qOTwKOwnVMRWEDHZgIFMv/view" class="btn btn-outline-success">Baixar template .doc</a>
                    </li>
                </ul>

                <h2 class="mt-4">Resumos</h2>
                <p class="fs-5">Devem ter 3 páginas e estar formatados de acordo com o modelo SBC:</p>
                <ul>
                    <li>LaTeX: 
                        <a href="https://www.overleaf.com/latex/templates/sbc-conferences-template/blbxwjwzdngr" target="_blank" class="btn btn-outline-success">Ver template no Overleaf</a>
                    </li>
    ...
    <section class="container text-center normas-apresentacao my-5">
        ...
        <p class="fs-4">Os trabalhos aceitos deverão ser apresentados no SETIF 2024 em apresentação oral presencial. Detalhes sobre a agenda serão divulgados após a revisão dos trabalhos.</p>
        <h2 class="py-3"><i class="bi bi-clock"></i> Tempo de Apresentação</h2>
        <p><?= $normas->getTempoApresentacaoResumo() ?> minutos para resumos, <?= $normas->getTempoApresentacaoArtigo() ?> minutos para artigos completos.</p>
    </section>
