...
<body>
    <?php include_once LIB_INCLUDES_2024 . DS . 'navbar-novo.php' ?>
    ...
    <section class="container-fluid normas-datas py-5">
        <div class="row border-bottom">
            ...
            <div class="col-12 col-md-6 p-4 text-secondary normas-submissao">
                ...
                <p class="fs-5">Sistema de submissão: <a href="https://tecnoif.com.br/sistemas/openconf/openconf.php" target="_blank" class="btn btn-outline-success">Clique aqui</a></p>
                ...
                <ul>
                    <li>LaTeX: <a href="https://www.overleaf.com/latex/templates/sbc-conferences-template/blbxwjwzdngr" target="_blank" class="btn btn-outline-success">Ver template no Overleaf</a></li>
                    <li class="mt-2">Modelo SBC .doc: <a href="https://drive.google.com/file/d/1H_29Hg5N534qOTwKOwnVMRWEDHZgIFMv/view" class="btn btn-outline-success">Baixar template .doc</a></li>
                </ul>
